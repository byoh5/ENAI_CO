...
extern void new_conv_float(double *input_data, int input_height, int input_width, double *kernel_data, int kernel_height, int kernel_weight,
	double *output_data, int output_height, int output_width, int stride, int padding);
extern void standard_convolution_float(double *input_data, int input_height, int input_width, int input_ch, double *kernel_data, int kernel_height, int kernel_width, int kernel_ch,
	double *output_data, int output_height, int output_width, int stride, int padding);
extern void depthwise_convolution_float(double *input_data, int input_height, int input_width, int input_ch, double *kernel_data, int kernel_height, int kernel_width, int kernel_ch,
	double *output_data, int output_height, int output_width, int stride, int padding);
extern void ReLU_float(double *input_data, int input_height, int input_width, int input_ch);
extern void new_max_pool_float(double *input_data, int input_height, int input_weight, int input_ch, double *result, int kernel_height, int kernel_weight, int stride);
extern void global_average_pooling_float(double *input_data, int input_height, int input_width, int input_ch, double *out_data);
extern void softmax_float(double *input_data, int in_length);
extern void file2data_float(char *filename, double *input_data);
...
extern void layer_dump_float(double *data, int size, char* outfile);
